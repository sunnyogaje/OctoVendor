    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <CardRow 
          ...
          onPress={() => router.push("/(main)/other/account/profile/profile")}
        />
         {/* Section: Store */}
        ...
        <CardRow 
          ...
          onPress={() => router.push("/(main)/other/account/store/store-info")}
        />
        <CardRow
          iconBg
          size={s}
        ...
        <CardRow 
          ...
          label="Delivery" 
          onPress={() => router.push("/(main)/other/account/delivery/settings")}
        />
        <CardRow 
          iconBg 
          size={s} 
          ...
          label="Menu" 
          onPress={() => router.push("/(main)/other/menu")}
        />
        <CardRow 
          iconBg 
          size={s} 
